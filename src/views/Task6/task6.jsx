        ...
        <GridContainer>
          <GridItem xs={12} sm={12} md={12}>
            <Card chart>
              ...
              <CardBody>
                <h4 className={classes.cardTitle}>Health Care Workers</h4>
                <p className={classes.cardCategory}>
                  <span className={classes.successText}>
                    <ArrowUpward className={classes.upArrowCardCategory} /> 10%
                  </span>{" "}
                  increase in health care worker training.
                </p>
              </CardBody>
              <CardFooter chart>
          ...
          <GridItem xs={12} sm={12} md={12}>
            <Card chart>
              ...
              <CardBody>
                <h4 className={classes.cardTitle}>Adherance to prescription practices</h4>
                <p className={classes.cardCategory}>
          ...
          <GridItem xs={12} sm={12} md={12}>
            <Card chart>
              ...
              <CardBody>
                <h4 className={classes.cardTitle}>Health Care Worker Training Correlaton</h4>
                <p className={classes.cardCategory}>
                  Last Campaign Performance
                </p>
              </CardBody>
